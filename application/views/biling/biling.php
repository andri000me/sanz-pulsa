        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand"><h4><b>Promo Sanz Cellular Saat Ini:</b></h4></a>
                    <marquee behavior="scroll" scrollamount="15" direction="left" width="900">
                        <h3><p class="black">[Promo Paket Data] Telkomsel 1GB: Rp.10.000,-</p></h3>
                    </marquee>
                </div>
            </div>
        </nav>
        ...
        <div class="container">
            <div class="panel-group">
                <div class="panel panel-primary">
                    <div class="panel-heading"><h4><center>Selamat Datang di Sanz Cellular. :) Silahkan Pilih Jenis Pulsa</center></h4></div>
