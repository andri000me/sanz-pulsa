        ...
        <div class="panel-body">
            ...
            <table class="table table-bordered">
                <tr><td>
                        ...
                        <div class="col-sm-2">
                            <input name="provedor" id="nama_proveder" required="" placeholder="provider" readonly="" class="form-control">
                       </div>
                        <div class="col-sm-1">
                            <input type="text" name="qty" placeholder="QTY" required="" value="1" class="form-control" readonly="">
                        </div>  
                        <button type="submit" name="submit" class="btn btn-success">Simpan</button>
                        <?php echo anchor('transaksi/selesai_belanja', 'Proses Semua!', array('class' => 'btn btn-success')) ?>
                    </td></tr>
            </table>
            <?php echo form_close(); ?>
                        ...
                        <table class="table table-bordered">
                            ...
                            foreach ($nominal as $row):
                                ...
                                <tr>
                                    ...
                                    <td><?php echo anchor('transaksi/selesai_belanja', 'Proses!', array('class' => 'btn btn-success')) ?></td>
                                </tr>
                                <?php $no++; ?>
<?php endforeach; ?>      
                        </table>
